...
# a) He instalado las librerias necesarias para el actual proyecto, contenidas en el archivo 'requeriments.txt'
# b) Ya he instalado PostgreSQL y la interfaz pgAdmin en mi computador
# c) He creado mi database y usuario con contrasena mediante pgAdmin 4, no con la consola
# d) El archivo .env ha sido editado con la informacion anterior, el DB_HOST y DB_PORT
...
# Inserto los datos para cada tabla, indicados en el archivo 'insert.sql'
